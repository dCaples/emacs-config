...
(use-package evil
  ...
  (use-package evil-leader
    :config
    (defun reload-emacs ()(interactive) (load-file "~/.emacs.d/init.el"))
...
(use-package evil-nerd-commenter
  ...
  ;; :config (define-key evil-normal-state-map (kbd "g c") 'evilnc-comment-or-uncomment-lines)
